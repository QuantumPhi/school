    ...
    \section{\label{sec:result}Results and Data Analysis}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [thick, red] table [y={create col/linear regression={y=e_avg}},col sep=comma]{height_standard.dat};
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [thick, red] table [y={create col/linear regression={y=e_avg}},col sep=comma]{bearings_standard.dat};
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [thick, red] table [y={create col/linear regression={y=e_avg}},col sep=comma]{height_magnet.dat};
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [thick, red] table [y={create col/linear regression={y=e_avg}},col sep=comma]{bearings_magnet.dat};
